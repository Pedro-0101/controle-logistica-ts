export const COMPANY_CONFIG_DOCS = {
  findOne:
    ...
    '- **Jornada (relatórios de tempo):** `journeyWindowStart`, `journeyWindowEnd`, `journeyWindowDays`\n\n' +
  ...
  update:
    ...
    '**Janela de jornada (relatórios de tempo — `GET /reports/*`):**\n' +
    '- `journeyWindowStart` / `journeyWindowEnd`: horário local (HH:MM) da jornada. Movimentos de ' +
    'permanência/trânsito que cruzem fora da janela (ex.: virada de noite) são marcados como atípicos ' +
    'e ficam fora das estatísticas de tempo.\n' +
    '- `journeyWindowDays`: dias da semana em CSV (ISO: 1=segunda ... 7=domingo). Ex.: `1,2,3,4,5`.\n\n' +
    '**Exemplo — Configurar jornada (06:00–22:00, seg a sex):**\n' +
    '```json\n' +
    '{\n' +
    '  "journeyWindowStart": "06:00",\n' +
    '  "journeyWindowEnd": "22:00",\n' +
    '  "journeyWindowDays": "1,2,3,4,5"\n' +
    '}\n' +
    '```\n\n' +
